...
console.log(amount);console.log(parseInt('1'.padEnd(decimals, '0')));console.log(amount / parseInt('1'.padEnd(decimals, '0')));
    let transferResult = await Moralis.transfer({
        type: 'erc20',
        amount: Moralis.Units.Token(amount / parseInt('1'.padEnd(decimals, '0')), decimals),
        receiver: shopWallet,
