<nav x-data="{ open: false }" class="bg-indigo-900 border-b border-white text-white">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('landing') }}" style="margin-top: 100px;">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-white hover:text-white hover:border-red-600 focus:outline-none focus:text-white focus:border-red-300 transition duration-150 ease-in-out">
