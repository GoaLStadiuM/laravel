                    ...
                    <div class="w-full bg-black rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                        <form name="manualHash" id="manualHash" method="post" action="{{ route('manualhash.check') }}">
                            ...
                            <div class="text-center">
                                ...
                                <button style="padding: 8px; background-image: url('{{ asset('img/bg/bg_btn_header.png') }}'); color:white; border: 2px solid white; border-radius: 10px; background-size: cover;">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
