<section class="team-bg" id="play2earn">
    <div class="container custom-container">
        <div class="row">
            <div class="col-12">
                <div class="third-section-title text-center mb-60">
                    <h2>PLAY<span>2EARN</span></h2>
                </div>
            </div>
        </div>
        ...
        <div class="container custom-container pt-120" id="nfts">
            <div class="row">
                <div class="col-12">
                    <div class="third-section-title text-center mb-60">
            ...
            <div class="text-center">
                <br>
                <a href="{{ route('shop') }}" class="btn rotated-btn text-center">Shop</a>
            </div>
        </div>
    </div>
</section>
