            ...
            <div class="col-lg-6">
                <div class="third-about-content">
                    <div class="third-title-style text-center">
                        <h2>Bienvenidos<br>a GoaL <span>StadiuM</span></h2>
                        <br>
                        <p>Un juego global inspirado en las más puras y grandiosas ligas del panorama futbolístico internacional actual, que proporciona una experiencia de juego totalmente nueva y muy original que irá evolucionando día a día la experiencia inmersiva en un entorno digital perfectamente diseñado para acumular valor en la red, proporcionando una experiencia de juego única a la vez que se consiguen recompensas cuantiosas e increíbles a través de Play to Earn</p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="third-section-title text-center mb-75">
                        <h2>Metaverso <span>Goal</span></h2>
                        <h6>Hasta 6 formas diferentes de jugabilidad</h6>
                    </div>
                </div>
            </div>
